...
Public Class CreateAgree
    ...
    Private Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Else
            Try
                create("INSERT INTO agreementBlotter (`id`, `agreementDate`, `agreementLocation`, `officeName`, `complainantName`, `victim`, `suspect`, `witness`, `agreement`) VALUES('" & id.Text _
                  & "','" & tbDate.Value.Date.ToString("yyyy/MM/dd") & "','" & tbLocation.Text & "', '" & tbOffice.Text & "', '" & tbCname.Text & "', '" & tbVname.Text & "', '" & tbSname.Text & "', '" & tbAgreement.Text & "')")
